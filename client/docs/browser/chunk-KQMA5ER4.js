...
`;var Pt=["icon"],Ot=["content"],vt=t=>({$implicit:t});function Lt(t,r){t&1&&re(0)}function Ht(t,r){if(t&1&&b(0,"span",0),t&2){let e=h(3);g(e.cn(e.cx("icon"),e.checked?e.onIcon:e.offIcon,e.iconPos==="left"?e.cx("iconLeft"):e.cx("iconRight"))),s("pBind",e.ptm("icon"))}}function zt(t,r){if(t&1&&H(0,Ht,1,3,"span",2),t&2){let e=h(2);z(e.onIcon||e.offIcon?0:-1)}}function Vt(t,r){t&1&&re(0)}function Rt(t,r){if(t&1&&w(0,Vt,1,0,"ng-container",1),t&2){let e=h(2);s("ngTemplateOutlet",e.iconTemplate||e._iconTemplate)("ngTemplateOutletContext",de(2,vt,e.checked))}}function jt(t,r){if(t&1&&(H(0,zt,1,1)(1,Rt,1,4,"ng-container"),a(2,"span",0),m(3),l()),t&2){let e=h();z(e.iconTemplate?1:0),d(2),g(e.cx("label")),s("pBind",e.ptm("label")),d(),le(e.checked?e.hasOnLabel?e.onLabel:"\xA0":e.hasOffLabel?e.offLabel:"\xA0")}}var $t=`
    ${mt}
